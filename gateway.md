...
2. 网关与控制器的通讯协议 建议 采用 LoRaWan 协议，如果采用专用协议，需要支持 QOS 1 质量，网关和控制器支持去重。
3. 网关支持 4G 通讯模块，支持全网通网络。
4. 网关至少支持 2 路 LoRa 收发模块，可以同时工作在不同的频率。
5. 网关支持蓝牙模块，要求支持LE功率控制，建议采用 5.2 版本的蓝牙模块。
6. 网关支持电池供电和电源供电。
